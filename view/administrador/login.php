...
?>
   <div class="alert alert-success">
        ...
        <?php /* datos del administrador desde la base de datos */
           /*foreach ($dataToView["data"] as $correo)
           {
            echo "Bienvenido  ". $correo["MAIL"];

           }*/
           echo "Bienvenido  ". $_SESSION["usuario"];
       ?>
			     <a href="index.php?controller=cursos&action=mostrar_formulario">Editar Cursos</a>
  	</div>
    <?php
   }
     ?>
